...
- `src/content/tilemaps.ts`: tile ids, tilemap sinh bằng lưới, tile collision và terrain.
...
Muốn thêm map mới theo hướng lâu dài: thêm tilemap trong `src/content/tilemaps.ts`, gắn vào entry `MAPS`, rồi đặt NPC/item/exit theo tọa độ tile. Map cũ vẫn có thể dùng background ảnh + collision mask trong lúc migrate.

## Vật lý/terrain

- Làng Tre hiện chạy bằng tilemap: mỗi ô tile có loại terrain/collision riêng, nên rào/ruộng/nước không cần đo mask thủ công.
